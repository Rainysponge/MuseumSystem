			...
			<view class="uni-list-cell" hover-class="uni-list-cell-hover" v-for="(item,index) in devhistory" :key="index">
				...
				<view class="uni-media-list" v-if="item.data.infostring">
					<view class="uni-media-list-body">
						<view class="uni-media-list-text-top">藏品名:&nbsp;{{item.data.infostring.T}}'C&nbsp;年代:&nbsp;{{item.data.infostring.H}}%</view>
						<view class="uni-media-list-text-bottom uni-ellipsis">简介: {{item.timestamp}}</view>
					</view>
				</view>
			</view>
		</view>
